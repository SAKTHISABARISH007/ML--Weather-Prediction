...
## Algorithm
1.Load dataset, clean column names, convert time column, sort data, and fill missing values using interpolation.

2.Create time-based features (hour, sine, cosine) and lag features (previous values) for better prediction.

3.Split data into training and testing sets, then train a Random Forest Regressor for each target variable.

4.Predict values, evaluate using R² and MAE, visualize results, and forecast next-step values using latest data.
...
## Output:
![Screenshot_17-3-2026_2008_localhost](https://github.com/user-attachments/assets/7b91d738-1e51-4aad-a180-2e50c7eebfcb)
![Screenshot_17-3-2026_20023_localhost](https://github.com/user-attachments/assets/247ab4ac-4a30-40c1-96c1-97266b154314)
![Screenshot_17-3-2026_20036_localhost](https://github.com/user-attachments/assets/7b7b14ed-c14f-42fd-810f-35f998efbaa6)



## Result:
 Displays processed data info, model performance (R², MAE), graphs, and next-step predictions for temperature, PM2.5, and TSR.
